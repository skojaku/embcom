...
# @Last Modified time: 2022-12-09 15:54:09
import numpy as np
from . import utils
from node2vecs.node2vec import Node2Vec
from .models import Word2Vec
from .loss import LaplacianEigenMapTripletLoss
from .dataset import LaplacianEigenMapDataset
...
class TorchLaplacianEigenMap(Node2Vec):
    def __init__(
        self,
        batch_size=256,
        device="cpu",
    ...
    def update_embedding(self, dim):
        ...
        loss_func = LaplacianEigenMapTripletLoss(n_neg=self.negative)
        ...
        dataset = LaplacianEigenMapDataset(
            adjmat=self.adjmat,
