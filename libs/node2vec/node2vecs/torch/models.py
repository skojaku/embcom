...
# @Last Modified time: 2022-10-14 14:36:29
import torch
...
class Word2Vec(nn.Module):
    def __init__(self, n_nodes, dim, orthogonal_constraint=False):
        ...
        if orthogonal_constraint:
            geotorch.orthogonal(self.ivectors, "weight")
            geotorch.orthogonal(self.ovectors, "weight")
